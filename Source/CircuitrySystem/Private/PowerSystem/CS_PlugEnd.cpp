...
void ACS_PlugEnd::UpdateAttachedPowerState()
{
	...
	**/
	...
	if(TaggingSystemComp->ActiveGameplayTags.HasTag(ItemTag_Power_Giver))
	{
	...
	else if(TaggingSystemComp->ActiveGameplayTags.HasTag(ItemTag_Power_Receiver))
	{
		...
		for(AActor* AttachedActor : AttachedActors)
		{
			...
			AttachedPowerCable->TaggingSystemComp->ActiveGameplayTags.AddTag(ItemTag_Power_Giver);
