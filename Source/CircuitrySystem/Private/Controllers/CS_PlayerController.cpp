...
#include "Controllers/CS_PlayerController.h"
...
void ACS_PlayerController::SetupInputComponent()
{
	...
	CSEnhancedInputComponent->BindActionByTag(InputConfig, InputTag_Move, ETriggerEvent::Triggered, this, &ACS_PlayerController::Move);
	CSEnhancedInputComponent->BindActionByTag(InputConfig, InputTag_Look_Mouse, ETriggerEvent::Triggered, this, &ACS_PlayerController::Look);
	CSEnhancedInputComponent->BindActionByTag(InputConfig, InputTag_Look_Stick, ETriggerEvent::Triggered, this, &ACS_PlayerController::Look);
}
